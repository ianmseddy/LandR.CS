...
#' makeClimateVariablesForGMCS
#' Prepares climate variables for use in gmcsDataPrep module with either projected
#' or historical (hindcasted) climate
#'
#' @param vars Desired climate variables
#' @param type Character of either "projected" (i.e. forecasting climate) or "historical" (hindcasting climate)
#' @param years Numeric. Years for forecasting/hindcasting
#' @param yearType Character of either "future_period" or "historical_period"
#' @importFrom stats setNames
#' @rdname makeClimateVariablesForGMCS
#' @export
makeClimateVariablesForGMCS <- function(vars,
                                          type = "projected",
                                          years = 2020:2050,
